  ...
  plugins: [
    ...
    new CopyPlugin({
      patterns: [
        ...
        {
          from: path.resolve(__dirname, 'components/**/snippet.*.liquid').replaceAll('\\', '\/'),
          to({ absoluteFilename }) {
        ...
        {
          from: path.resolve(__dirname, 'components/**/section.*.liquid').replaceAll('\\', '\/'),
          to({ absoluteFilename }) {
        ...
        {
          from: path.resolve(__dirname, 'fonts/**/*.(woff|woff2)').replaceAll('\\', '\/'),
          to({ absoluteFilename }) {
